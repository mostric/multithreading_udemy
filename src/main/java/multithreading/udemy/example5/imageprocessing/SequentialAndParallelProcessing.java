package multithreading.udemy.example5.imageprocessing;
...
public class SequentialAndParallelProcessing {

    public static final String SOURCE_FILE = "src/main/resources/many-flowers.jpg";
    public static final String DESTINATION_FILE = "src/main/resources/out/many-flowers.jpg";
...
//        recolorSingleThreaded(originalImage, resultImage);
    ...
    public static void recolorImage(BufferedImage originalImage, BufferedImage resultImage,
        ...
        for (int x = leftCorner; x < leftCorner + width && x < originalImage.getWidth(); x++) {
            for (int y = topCorner; y < leftCorner + height && y < originalImage.getHeight(); y++) {
